...
$(function(){
	...
	if(page_no > 1){
		$("#left_sider_btn").click(function(){
			...
			var page = page_no - 1;
			location.href="./view_container_v8.php?idx="+idx+"&page="+page;		
		});
	}
	...
	$("#calc_btn").click(function(){
		...
		$.ajax({ 
				...
				success: function(data) {
					//console.log(data)
					location.href="./view_container_v8.php?idx="+idx+"&page=1";
				} 
		});	 
...
for(var k=0 ; k < item_arr.length ; k++){
	...
	****************/
	...
	var product_material = new THREE.MeshBasicMaterial( {color: 0xffffff} );
...
var groundColor = 0xb9b9b9;  
var intensity = 1;
var light = new THREE.HemisphereLight(skyColor, groundColor, 1.5);
scene.add(light);
