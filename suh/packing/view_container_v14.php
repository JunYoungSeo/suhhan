	...
	<div id="header_div">
		<div id="left_header_div">
			<div id="left_header_1_div">
				<img src="./image/bizi4.png" width="60%" style="padding:7% 10%">
			</div>
...
$(function(){
	...
	if(page_no > 1){
		$("#left_sider_btn").click(function(){
			...
			var page = page_no - 1;
			location.href="./view_container_v14.php?idx="+idx+"&page="+page;		
		});
	}
	...
	$("#calc_btn").click(function(){
		...
		$.ajax({ 
				...
				success: function(data) {
					//console.log(data)
					location.href="./view_container_v14.php?idx="+idx+"&page=1";
				} 
		});	 
	...
	locations2 = locations2 + product_length_size + 10;
		...
		for(let z=0; z < max_height_stack ; z ++){
			...
			for(let x=0; x < max_cp ; x++){
				...
				loader.load("./image/elbow90_.glb", function (gltf) {
