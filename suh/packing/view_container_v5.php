	...
	for(var z=0; z < max_height_stack ; z ++){
		...
		for(var x=0; x < max_cp ; x++){
			...
			*/
			...
			//var p_top = new THREE.Mesh(p1, new THREE.MeshBasicMaterial({ map:new THREE.TextureLoader().load( 'image/str_top.png' )}));
...
const material = new THREE.Mesh(geometry, new THREE.MeshBasicMaterial({color: 0xA9A9A9}));
material.position.x =  0
			material.position.y = product_height_size+1+m/10;
			material.position.z = container_end_location + xxx;
