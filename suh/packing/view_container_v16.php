	...
	$(function(){
		...
		if(page_no > 1){
			$("#left_sider_btn").click(function(){
				...
				var page = page_no - 1;
				location.href="./view_container_v16.php?idx="+idx+"&page="+page;		
			});
		}
		...
		$("#calc_btn").click(function(){
			...
			$.ajax({ 
					...
					success: function(data) {
						//console.log(data)
						location.href="./view_container_v16.php?idx="+idx+"&page=1";
					} 
			});	 
...
calc_empty_space(conWidth,conHeight,conLength,total_product_length);
animate();
...
function calc_empty_space(conWidth,conHeight,conLength,total_product_length){
