...
$(function(){
	...
	if(page_no > 1){
		$("#left_sider_btn").click(function(){
			...
			var page = page_no - 1;
			location.href="./view_container_v9.php?idx="+idx+"&page="+page;		
		});
	}
	...
	$("#calc_btn").click(function(){
		...
		$.ajax({ 
				...
				success: function(data) {
					//console.log(data)
					location.href="./view_container_v9.php?idx="+idx+"&page=1";
				} 
		});	 
...
for(var k=0 ; k < item_arr.length ; k++){
	...
	****************/
	...
	for(var z=0; z < max_height_stack ; z ++){
		...
		for(var x=0; x < max_cp ; x++){
				...
				if(z == 5 || z == 11){
					...
					crutch(p.position.x,p.position.y,p.position.z);
	...
	function crutch(x,y,z){
		
		/***************
		** 버팀목 부분   **
		****************/
		
		var crutch_wide_size = 1000;
		var crutch_height_size = 18;
		var crutch_length_size = 18;
