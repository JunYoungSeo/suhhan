...
<?	
	...
	for($i=0;$row = $sql->fetch();$i++){
		...
		if($height == "100"){
			...
			if($length == "3000"){
				...
				switch($wide){
					...
					case "150" : $ea_count = "9";break;
					case "300" : $ea_count = "6";break;
					case "450" : $ea_count = "4";break;
					case "600" : $ea_count = "3";break;
					case "750" : $ea_count = "2";break;
					case "900" : $ea_count = "2";break;
				...
				switch($wide){
					...
					case "150" : $ea_count = "4";break;
					case "300" : $ea_count = "3";break;
					case "450" : $ea_count = "3";break;
					case "600" : $ea_count = "3";break;
					case "750" : $ea_count = "2";break;
					case "900" : $ea_count = "2";break;
			...
			if($length == "3000"){
				...
				switch($wide){
					...
					case "150" : $ea_count = "5";break;
					case "300" : $ea_count = "4";break;
					case "450" : $ea_count = "4";break;
					case "600" : $ea_count = "3";break;
					case "750" : $ea_count = "2";break;
					case "900" : $ea_count = "2";break;
		...
		$item_wide = (($wide + $flange) * $ea_count ) + 200;

		$item_length = $length + 200;
		
		
		array_push($length_arr,$full_package_length."/".$item."/".$wide."/".$height."/".$length."/".$max_product_ea."/".$siderail_thick."/".$weight."/".$radius."/".$deg."/0/0/off/".$item_wide."/".$item_length);
	...
	for($i=0;$row = $sql->fetch();$i++){
		...
		if($elbow_x > 2080){
			...
			$full_package_length = $elbow_x + 200;

			$full_package_length = ceil($full_package_length/100) * 100;
			$elbow_rotate = "on";
		}else{
			$full_package_length = 1200; // $elbow_y + 200이 아님..
			$elbow_rotate = "off";
		}
		
		$item_wide = 
		$item_length = $full_package_length;

		array_push($length_arr,$full_package_length."/".$item."/".$wide."/".$height."/".$length."/".$max_product_ea."/".$siderail_thick."/".$weight."/".$radius."/".$deg."/".$elbow_x."/".$elbow_y."/".$elbow_rotate."/".$item_wide."/".$item_length);
