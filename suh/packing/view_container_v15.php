			...
			<div id="left_header_4_div">
				<div id="left_header_4_1_div">
					...
					<br>
						...
						<input type="text" style="width:33%;border:3px solid #0d47a1;float:left;padding: 5px 5px;margin-top: 13px;" <?if($h_margin){print "value=".$h_margin;}?> name="h_margin" placeholder="폭(Width)">
						<input type="text" style="width:33%;border:3px solid #0d47a1;float:left;padding: 5px 5px;margin-top: 13px;border-left: none;" <?if($v_margin){print "value=".$v_margin;}?> name="v_margin" placeholder="길이(Length)">
						<input type="text" style="width:33%;border:3px solid #0d47a1;float:left;padding: 5px 5px;margin-top: 10px;border-left: none;" <?if($height_margin){print "value=".$height_margin;}?> name="height_margin" placeholder="높이(Height)">
...
$(function(){
	...
	if(page_no > 1){
		$("#left_sider_btn").click(function(){
			...
			var page = page_no - 1;
			location.href="./view_container_v15.php?idx="+idx+"&page="+page;		
		});
	}
	...
	$("#calc_btn").click(function(){
		...
		$.ajax({ 
				...
				success: function(data) {
					//console.log(data)
					location.href="./view_container_v15.php?idx="+idx+"&page=1";
				} 
		});	 
	...
	locations2 = locations2 + product_length_size + 10;
		...
		for(let z=0; z < max_height_stack ; z ++){
			...
			for(let x=0; x < max_cp ; x++){
				...
				var imageurl = "./image/elbow90_.glb";
