...
var max_wide_stack = "<?=$max_wide_stack?>"; max_wide_stack = max_wide_stack * 1;
var max_height_stack = "<?=$max_height_stack?>"; max_height_stack = max_height_stack * 1;
var max_length_stack = "<?=$max_length_stack?>"; max_length_stack = max_length_stack * 1;

var item = "<?=$item?>"; 
var wide = "<?=$wide?>"; wide = wide * 1;
var height = "<?=$height?>"; height = height * 1;
var length = "<?=$length?>"; length = length * 1;
var radius = "<?=$radius?>"; radius = radius * 1;
var deg = "<?=$deg?>"; deg = deg * 1;
var quantity = "<?=$quantity?>"; quantity = quantity * 1;
...
for(var i = 0; i < max_height_stack ; i ++){ // 1차적으로 높이 갯수만큼 반복 

	for(var j = 0; j < max_wide_stack ; j ++){ // 2차적으로 와이드 갯수만큼 반복 ( 왼쪽부터 쌓는다..)
